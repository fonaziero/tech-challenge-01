...
import Ilustration from '../../../assets/Ilustração Banner.png';
import Button from '../../UI/buttons/button/button';
import InfoItems from '../info-items';
import Presente from '../../../assets/Ícone Presente.png';
import Saque from '../../../assets/Ícone Saque.png';
import Pontos from '../../../assets/Ícone Pontos.png';
import Dispositivos from '../../../assets/Ícone Dispositivos.png';
        ...
        <Container>
            <section className="container mx-auto flex flex-col md:flex-row items-center pt-12">
                ...
                <div className="md:w-1/2 flex justify-center">
                    <img src={Ilustration.src} alt="Gráfico financeiro" className="w-auto h-auto" />
                </div>
            </section>
